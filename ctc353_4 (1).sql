...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2017 at 06:32 AM
...
(1, 'Construction of a bungalow house', 105, 210, '2016-07-15', '2016-09-18', 'Ahuntsic', 'Complete', '286668', '177481'),
...
(10, 'Construction', 109, 206, '2017-01-19', '2017-11-29', 'Saint-Lambert', 'In Progress', '0', '22289083');
...
(1, 1, 1, 'Structural and architecture design', '2016-07-15', '2016-07-15', '716', '2016-07-21', '2016-07-21', '80000', 'Complete'),
...
(1, 1, 10, 'Structural', '2017-01-19', '2017-01-19', '0', '2017-02-19', '2017-02-19', '0', 'In Progress'),
(2, 1, 10, 'Acquisition', '2017-01-19', '2017-01-19', '0', '2017-02-19', '2017-02-19', '0', 'In Progress'),
(3, 1, 10, 'Site', '2017-01-19', '2017-01-19', '0', '2017-02-19', '2017-02-19', '0', 'In Progress'),
(4, 2, 10, 'trigger task', '2017-04-10', '2017-04-11', '2222', '2017-04-10', '2017-04-11', '22222', 'In Progress'),
...
--
DELIMITER $$
CREATE TRIGGER `update_project_total_based_on_tasks_insert` AFTER INSERT ON `task` FOR EACH ROW UPDATE project a
   SET a.actualCost = 
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_project_total_based_on_tasks_update` AFTER UPDATE ON `task` FOR EACH ROW UPDATE project a
   SET a.actualCost = 
    (SELECT SUM(actualCost) 
       FROM task
      WHERE projectID = a.projectID)
